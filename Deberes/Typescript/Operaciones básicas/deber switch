...
//Ejemplo numero 2
const HerramientaFerreteria = prompt("ingrese la herramienta a comprar");
...
const A = String("tiene 31 días");
const B = String("tiene 30 días");
const C = String("tiene 28 días");
switch(mes){
