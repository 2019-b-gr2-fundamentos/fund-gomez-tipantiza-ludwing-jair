...
async function main(){
    ...
    //un parseo esta correctamente realizado
    //si tenemos un objeto el cual podemos parsear
    ...
    */
    let arregloCargadoDeArchivo;
     // si no guardo ningun valor
    //en una variable en javascript la variable tiene un valor undefined
    try{
...
//throw error --> el programa se cae
    let contador = 1;
...
//cath es el lugar de donde van un lanzamiento de un error
    /*
    try{
        console.log('1');
        console.log('2');
        ...
        podemos mandar cualquier error si lo nec
        console.log('4');
        console.log('5');
    }catch(error){
        console.log(error);
