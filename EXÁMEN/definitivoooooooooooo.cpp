...
void editar(string UniversidadUno, string UniversidadDos,string UniversidadTres){
     
    string Univ[3] = {UniversidadUno, UniversidadDos,UniversidadTres};
    string mensaje;
    cin>>mensaje;
    ...
    for(int j = 0; j<3;j++){
        ...
        cout<<endl<<Univ[j]<<" cambiar a >>"<<mensaje;
        Univ[j]=mensaje;
        cout<<Univ[j]<<". "<<endl;
            
    }
    
    cout<<"\n\t   TUS UNIVERSIDADES:\n\t------------------------\n"<<Univ[0]<<endl<<Univ[1]<<endl<<Univ[2]<<"\t------------------------";}
