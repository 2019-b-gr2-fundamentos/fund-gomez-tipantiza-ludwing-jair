...
void universidad(){
    ...
    string toptres[3]; //EN ESTE AREGLO VAMOS A GUARDAR A LOS POKEMONES
...
void PreguntaRempazo(){
    cout<<"\n\nDe Seguro te arrepentiste .Deseas editar tus tres mejores?\nSI --> 1.\nNO --> 2.";
    int Elige;
    cout<<"\nElige: "; cin>>Elige;
    switch(Elige){
        case 1:
